        ...
        'ecommerce': {
            ...
            'purchase': {
                ...
                'products': [{
                    ...
                    'category': 'ancillary/hotels/' + b['starRating'] + '/' +  b['hotelType'].toLowerCase(), //string - set the levels of category separated by "/" - first level "Ancillary", next level "hotels", then <star rating>, followed by <property type> (if available)
