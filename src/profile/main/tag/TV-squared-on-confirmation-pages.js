...
try {
  (function (id, loader) {
	...
	//TVSquared Conversion Script:
	window._tvq = window._tvq || [];
	(function () {
	  var session = {'user': u.data.customer_id || b._ccustid || ""};
	  var actionname = 'sale';
	  var action = {
	    'rev': u.data.order_subtotal || b._csubtotal || "",
	    'prod': u.data.product_name || "",
	    'id': u.data.order_id || b._corder || "",
	    'promo': u.data.promo_code || b._cpromo || "",
	    'device': u.data.device_type || "",
	    'currency': u.data.currency || ""
	  };
	  var uu = (("https:" == document.location.protocol) ? "https://collector-282.tvsquared.com/piwik/" : "http://collector-282.tvsquared.com/piwik/");
	  _tvq.push(['setSiteId', "TV-721872-1"]);
	  _tvq.push(['setTrackerUrl', uu + 'piwik.php']);
	  ...
	  var d = document, g = d.createElement('script'), s = d.getElementsByTagName('script')[0]; g.type = 'text/javascript'; g.defer = true; g.async = true; g.src = uu + 'tv2track.js';
