...
//tealium universal tag - utag.sender.2045 ut4.0.##UTVERSION##, Copyright ##UTYEAR## Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
    ...
    u.send = function (a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        omg.pixel.fireTagPixel({id: id, name: 'bing_ads_universal_event_tracking_uid253', label: 'Bing_Ads_Universal_Event_Tracking_UID253', context: {u: u, b: b}});
