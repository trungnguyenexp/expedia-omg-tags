...
try {
    ...
    u.send = function(a, b) {
        ...
        ##UTEXTEND##
            ...
            u.data._kpid = u.data._kpid || u.data.kpid_krux || '3d8e4b51-b537-4841-9086-4f59862457c6';
            ...
            u.data.roomType = u.data.roomType || b.roomType|| "";
            u.data.mergedOriginCode = u.data.originAirportCode || u.data.carPickUpLocationCode || "";
            u.data.mergedDestinationCode = u.data.destinationAirportCode || u.data.carDropOffLocationCode || "";
