...
//tealium universal tag - utag.sender.4001 ut4.0.##UTVERSION##, Copyright ##UTYEAR## Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
    ...
    u.send = function (a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        u.data = {
          ...
          "qty" : 0,
          "total_qty" : 0,
          "countertype" : "##UTVARconfig_countertype##",
          "conversioncount" : "##UTVARconfig_conversioncount##",
          // E-Commerce Vars
          "order_id" : "",
          "order_subtotal" : "",
          "product_id" : [],
        ...
        omg.pixel.fireTagPixel({id: id, name: 'doubleclick_flight_conf', label: 'DoubleclickFlightConf', context: {u: u, b: b}});
      }
    };
