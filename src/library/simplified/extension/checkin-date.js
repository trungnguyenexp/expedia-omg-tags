...
else if (utag.isRailSearchResults() && b['entity.railSearch.searchParameters.journeyLegs.0.isoFormatDate']!= undefined )
{
    b["checkInDate"] = b['entity.railSearch.searchParameters.journeyLegs.0.isoFormatDate'];
}
...
else if ((utag.isCruiseIS() || utag.isCruiseTP() || utag.isCruiseCabinN()) && b['entity.cruise.isoFormatDepartureDate'])
{
    ...
    else if (b['entity.checkout.activities.0.isoFormatStartDate']){
        b['checkInDate'] = b['entity.checkout.activities.0.isoFormatStartDate'];
    }
}
...
else if(utag.isRCO() && b['entity.checkout.railOffers.0.tripStartDateTime']){
    b['checkInDate'] = b['entity.checkout.railOffers.0.tripStartDateTime'];
}
if(b["checkInDate"] != '')
{
