...
window.utag.isFPymt = function(){
    if(pageName.indexOf("FLT_CKO_PMT") > -1 || pageName.indexOf("page.Flight.Checkout.Info") > -1 || pageName.indexOf("page.Flight.Checkout.Payment") > -1){
...
window.utag.isPPymt = function(){
    if(pageName.indexOf("PKG_CKO_PMT") > -1 || pageName.indexOf("page.Checkout.Payment") > -1 ){
